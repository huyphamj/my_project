...
public class LotteryDao extends SimpleJdbcDaoSupport {
	...
	public void insertLottery(int cat_id, String gen_date, int rank, String value) {
		...
		if (list == null || list.isEmpty()) {
			...
			if (cat_id == 2 || cat_id == 3 || cat_id == 4 || cat_id == 40)
				return;
			insertLoto(cat_id, gen_date, val);
		}
	}

	private void insertLoto(int cat_id, String gen_date, String value) {
		String sql = "INSERT INTO loto(cat_id, gen_date, value) VALUES (" + cat_id + ", '" + gen_date + "','" + value
				+ "')";
		getSimpleJdbcTemplate().update(sql);
	}
}
